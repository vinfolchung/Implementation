...
#import "ImageExtraModel.h"
#import "Editor.h"
#import "SubTitleCellModel.h"
/**
 *  全部cell的数据模型
 */
 ...
 *  里面放的是ImagExtra模型
 */
@property (nonatomic, strong) NSArray *imageExtraModel;
...
/**
 *  里面放的是SubTitleCellModel模型
 */
@property (nonatomic, strong) NSArray *subTitleCellModel;
